  ...
  return (
    <footer style={{ background: '#F5F5F0' }} className="text-[#043236]">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8 py-12 sm:py-20">
        ...
        {/* Mobile: single column | Tablet: 2-col | Desktop: 5-col */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 sm:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://www.linkedin.com/company/adaptive-nesting-technologies-ant/"
                target="_blank" rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center text-[#6F6F6F] hover:text-[#043236] hover:border-[#043236] transition-colors"
              >
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              {[
                ...
                <li key={label}>
                  <a href={href} className="text-sm text-[#6F6F6F] hover:text-[#043236] transition-colors">
                    {label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li>
                <a href="mailto:info@adaptivenestingtech.com" className="text-sm text-[#6F6F6F] hover:text-[#043236] transition-colors">
                  Email Support
                </a>
              </li>
            </ul>
