  ...
  return (
    <>
      <nav className="fixed top-8 left-1/2 -translate-x-1/2 z-50 w-full max-w-[90%] lg:max-w-5xl">
        <div className="bg-white/95 backdrop-blur-sm rounded-full shadow-md p-[18px] flex items-center justify-between px-[18px] py-[3px]">
          ...
          <div className="hidden md:flex items-center gap-8">
            <button onClick={() => handleNavClick('home')} className="text-[#6F6F6F] hover:text-[#043236] transition-colors">Home</button>
            <button onClick={() => handleNavClick('home', '#solutions')} className="text-[#6F6F6F] hover:text-[#043236] transition-colors">Solutions</button>
            <button onClick={() => handleNavClick('home', '#story')} className="text-[#6F6F6F] hover:text-[#043236] transition-colors">Our Story</button>
            <button onClick={() => handleNavClick('home', '#team')} className="text-[#6F6F6F] hover:text-[#043236] transition-colors">Team</button>
            <button onClick={() => handleNavClick('home', '#contact')} className="text-[#6F6F6F] hover:text-[#043236] transition-colors">Contact</button>
          </div>
